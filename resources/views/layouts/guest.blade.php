...
<head>
    ...
    <meta name="description" content="Access FitSpire Hub. Log in or create an account to start tracking your sports and fitness activities.">
    <title>@yield('title', 'Auth') - FitSpire Hub</title>
    <!-- Custom Style Sheet -->
...
<body>
    ...
    <div style="position: absolute; top: 20px; right: 20px; z-index: 10;">
        <button id="theme-toggle" class="theme-toggle-btn" aria-label="Toggle Theme" title="Toggle Light/Dark Mode" style="margin-left: 0;">🌓</button>
    </div>

    <div class="auth-wrapper">
        <div class="auth-card">
            <div class="auth-header">
                <div class="logo">⚡ FitSpire <span>Hub</span></div>
                @yield('header')
            </div>

            <!-- Alerts -->
            @if(session('success'))
                <div class="alert alert-success" id="guest-success-alert">
                    {{ session('success') }}
                </div>
            @endif
